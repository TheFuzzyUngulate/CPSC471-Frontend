...
<body>
	...
	<p>Insert your information in the following fields and an agent will get back to you</p>
	
	<form method='post' action='contact-agent.php'>
		First Name: <input type="text" name="fname"><br>
		Last Name: <input type="text" name="lname"><br>
		Email: <input type="text" name="email"><br>
		Phone Number: <input type="text" name="phone"><br>
		Reason for contacting an agent: <input type="text" name="reason"><br>
...
<?php
	...
	//incontact relationship
	$contact = "INSERT IGNORE INTO incontact (Buyer_email, BAgent_ID) VALUES ('". $email."','". $agentID."')";
